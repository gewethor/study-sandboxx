...
async function saveAsImgCompare() {
    ...
    async function doneReading() {
        ...
        console.log("SaveAsImgCompareCallback result: ", saveAsPixelDiff);
...
async function grabzitImgCompare() {
    ...
    console.log("Grabzit Image Compare");

    let resizeCallback = async function(newFileInfo) {
          console.log("...done");
          ...
          async function doneReading() {
              ...
              console.log("grabzitImgCompareCallback result: ", grabzitPixelDiff);
              console.log("...done");
